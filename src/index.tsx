...
const header = {
  title: "Product Executive, Advisor, and Angel Investor.",
  description:
    "I’m Frank a former VP of Product at Slack and other products you've used. I'm currently on sabbatical. I live in the Clinton Hill neighborhood in Brooklyn, NY. In my spare time, I like to cook and make bread.",
};
    ...
    return (
      <div className="mt-6 flex gap-6">
        ...
        <a
          ...
          href="https://instagram.com/hirefrank"
        >
          <comp.shared.icon
