                    ...
                    <div className="pointer-events-auto">
                        <button type="button" aria-label="Switch to dark theme"
                          ...
                          <svg viewBox="0 0 24 24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                               aria-hidden="true"
                               className="light-icon h-6 w-6 fill-zinc-100 stroke-zinc-500 transition group-hover:fill-zinc-200 group-hover:stroke-zinc-700 dark-hidden dark-fill-teal-50 dark-stroke-teal-500 dark-group-hover:fill-teal-50 dark-group-hover:stroke-teal-600">
                            <path
                          ...
                          <svg viewBox="0 0 24 24" aria-hidden="true"
                               className="dark-icon hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark-block dark-group-hover:stroke-zinc-400 dark-stroke-teal-500">
                            <path
